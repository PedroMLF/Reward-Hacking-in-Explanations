...
#SBATCH -o outputs/aqua/llama3-3B/dpo/training/log_train_gemma.txt

DPO_DATA_PATH="outputs/aqua/llama3-3B/dpo"
SAVE_PATH="checkpoints/llama3-3B/aqua_dpo"
...
for SEED in 0 1 2; do
    ...
    for RW in sk-gemma_original sk-gemma_aug-rm-c sk-gemma_aug-rm-d; do
        ...
        python -u ${PROJECT_HOME}/train_dpo.py \
            --dataset_path ${DPO_DATA_PATH_SEED}/cot_negative_${RW} \
            --model_name_or_path ${MODEL} \
            --output_dir ${SAVE_PATH_SEED}/cot_negative_${RW} \
            ...
            --beta 0.1 \
            --seed ${SEED} \
            --run_name aqua_dpo_negative_${RW}_seed-${SEED} \
            --use_peft \
            --lora_alpha 32 \
            --lora_r 16 \
            --lora_dropout 0.05 \
