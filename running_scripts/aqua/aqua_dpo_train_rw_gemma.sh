...
#SBATCH -o outputs/aqua/llama3-8B/dpo/training/log_train_gemma.txt
...
for APPROACH in negative; do
    for RW in skywork-gemma_none skywork-gemma_heuristic skywork-gemma_heuristic_oracle; do
